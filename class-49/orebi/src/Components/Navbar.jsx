        ...
        />
        {
          nevbar && (
            <ul className="w-full lg:flex absolute lg:static left-0 top-full z-10 bg-slate-200 lg:bg-transparent items-center gap-10  justify-center p-4 lg:p-0 ">
              ...
              <LIstItem Linktagtext="service" className=" hover:text-black font-semibold" />
              <LIstItem Linktagtext="blog" className=" hover:text-black font-semibold" />
              <LIstItem Linktagtext="contact" className=" hover:text-black font-semibold" />
            </ul>
          )
        }
